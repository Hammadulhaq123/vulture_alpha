        ...
        <div  className="relative w-full flex justify-start items-start gap-2 h-auto p-4 lg:p-6">
            <div className='w-full h-auto flex flex-col gap-2 justify-start items-start'>
                <div className='w-full h-auto flex items-center justify-end'>
                    <button onClick={() => setIsOpen((prev) => !prev)} className='w-28 h-8 bg-green-500 text-white flex justify-center items-center rounded-md'>
                        <FaPlus className='text-xs mr-2'/> Create
                    </button>
                </div>
