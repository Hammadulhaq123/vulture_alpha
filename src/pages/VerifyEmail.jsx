                ...
                <div className='flex w-full h-auto flex-col px-4 justify-start items-start gap-6'>
                    ...
                    <form  className='w-full flex  flex-col gap-3'>
                        ...
                        onClick={submitAndNavigate}
                            className='w-full select-none bg-[#c00000] text-white font-bold text-md border-none outline-none h-12 px-3 rounded-full  focus-within:border-blue-400 hover:shadow transition duration-150' >Send Code</button>
