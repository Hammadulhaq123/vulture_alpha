...
const UserCard = ({user}) => {
    return (
        <div className='w-[48%] lg:w-[32.6%] xl:w-[24.5%] h-24 lg:h-28 p-2 md:p-3 flex flex-col justify-center rounded-xl items-start gap-1  bg-[#1c1c1c] border border-[#c00000]'>
