...
const DeleteGroupModal = ({ isOpen, setIsOpen }) => {
    ...
    return (
        ...
        <div onClick={toggleModal} id='notification-modal' className={`fixed top-0 left-0 bg-[#fff]/[0.2] z-[1000] w-screen h-screen ${isOpen ? "flex" : "hidden"} items-center justify-center`}>
            <div ref={deleteRef} className='w-96 h-auto flex flex-col gap-6 justify-start items-start bg-[#0e0e10] p-8'>
                <span className='text-2xl font-bold text-white'>Are you sure want to delete this group?</span>
